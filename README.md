...
This script automates a "data import", which before was to download a file from an ftp server, unzip, change the... blah blah blah - takes a long time, you have to wait to connect to the ftp servers, it's repetitive boring and annoying.
